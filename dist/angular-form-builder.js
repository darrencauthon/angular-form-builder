  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', function($scope, $injector) {
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, description, placeholder, required, options, validation, expand]', function() {
          ...
          return formObject.expand = $scope.expand;
        }, true);
      ...
      return $scope.data = {
        ...
        rollback: function() {
          ...
          return $scope.expand = this.model.expand;
        }
      };
    }
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertFormObject = function(name, formObject) {
      ...
      result = {
        ...
        expand: (_ref10 = formObject.expand) != null ? _ref10 : component.expand
      };
      return result;
    };
